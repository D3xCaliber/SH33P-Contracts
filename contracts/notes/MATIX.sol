...
/* ROOTKIT:
Technically a wrapped WMATIC
So a wrapped wrapped ethereum
But also accepts raw MATIC
...
contract MATIX is ERC31337, IWETH
{
    ...
    constructor (IWETH _weth) ERC31337(_weth, "X3defi Matic", "MATIX")
    {
    ...
    {
        require (_burnRate <= 2000 , "Dump tax rate should be less than or equal to 20%"); 
